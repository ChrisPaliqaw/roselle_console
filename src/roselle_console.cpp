...
class RoselleConsole : public rclcpp::Node
{
public:
  // Initiate a Node called 'simple_subscriber'
  RoselleConsole()
  : Node("roselle_console")
  {
    ...
    subscription_ = this->create_subscription<std_msgs::msg::Int32>(
      "counter", 10, std::bind(&RoselleConsole::topic_callback, this, _1));
  }
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::spin(std::make_shared<RoselleConsole>());
  rclcpp::shutdown();
  return 0;
}
